...
from train3 import SimpleCNNUnified  # Upewnij się, że importujesz poprawny moduł/model

# --- Ścieżki i konfiguracja ---
IMAGES_TO_PREDICT_DIR = 'Data/PhotosToPredict'
MODEL_LOAD_PATH = 'best_model_3color_lab.pth'
...
if __name__ == '__main__':
    ...
    for image_path in image_files:
        ...
        lab1 = denormalize_lab(pred_lab_norm[0:3])
        lab2 = denormalize_lab(pred_lab_norm[3:6])
        lab3 = denormalize_lab(pred_lab_norm[6:9])

        hex1 = convert_lab_to_hex(lab1)
        hex2 = convert_lab_to_hex(lab2)
        hex3 = convert_lab_to_hex(lab3)
        ...
        for i, (hex_val, ax) in enumerate(zip([hex1, hex2, hex3], axes[1:]), 1):
