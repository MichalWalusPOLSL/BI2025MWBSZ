...
from train2 import SimpleCNNUnified

# --- Ścieżki i konfiguracja ---
IMAGES_TO_PREDICT_DIR = 'Data/PhotosToPredict'
MODEL_LOAD_PATH = 'best_model_2color_lab.pth'
...
if __name__ == '__main__':
    ...
    for image_path in image_files:
        ...
        lab1 = denormalize_lab(pred_lab_norm[:3])
        lab2 = denormalize_lab(pred_lab_norm[3:])
        ...
        axes[1].set_facecolor(hex1)
        axes[1].set_title(f"Kolor 1\n{hex1}")
        axes[1].set_xticks([]); axes[1].set_yticks([])

        axes[2].set_facecolor(hex2)
        axes[2].set_title(f"Kolor 2\n{hex2}")
