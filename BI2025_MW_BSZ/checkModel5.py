...
from train5 import SimpleCNNUnified  # <-- Zmień na właściwy plik/model

# --- Ścieżki i konfiguracja ---
IMAGES_TO_PREDICT_DIR = 'Data/PhotosToPredict'
MODEL_LOAD_PATH = 'best_model_5color_lab.pth'
...
if __name__ == '__main__':
    ...
    for image_path in image_files:
        ...
        labs = [denormalize_lab(pred_lab_norm[i*3:(i+1)*3]) for i in range(5)]
